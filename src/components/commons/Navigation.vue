    ...
    <div class="main">
        <div class="button">
            <button v-on:click="toggleNav()">
                <font-awesome-icon :icon="isOpen? 'times' : 'bars'" size="lg"></font-awesome-icon>
            </button>
        </div>
        <div class="sidenav" v-bind:class="{navOpen:isOpen}">
            <div class="nav-content">
                        <svg version="1.1" id="Ebene_5" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                        viewBox="0 0 1516.6 1281.6" style="enable-background:new 0 0 1516.6 1281.6;" xml:space="preserve" width="600" >
                            <g id="Anatomie" ref = "anatomy" class="component">
                                <g id="Icon" :class = "{'active':currentPageName === 'anatomy' }" >
                                ...
                                <g id="Titel"  :class = "{'active':currentPageName === 'anatomy' }">
                            ...
                            <g id="Resonatoren"  class="component" :class = "{'active':currentPageName === 'resonator' }" ref="resonator">
                            ...
                            <g id="Sprachsynthese"    class="component" ref="synthesis">
                                <g id="Icon_1_" :class = "{'active':currentPageName === 'synthesis' }">
                                    ...
                                    <path class="st0" d="M1362.8,1132.8V1114h40.4v18.8H1362.8z"/>
                                        ...
                                        <rect x="1200.9" y="1079.3" transform="matrix(0.4782 -0.8782 0.8782 0.4782 -265.6704 1721.4305)" class="st0" width="230" height="10"/>
                                </g>
                                <g id="Titel_2_" :class = "{'active':currentPageName === 'synthesis' }">
                            ...
                            <g id="Kempelen"  class="component" ref="kempelen">
                                <g id="Icon_2_" :class = "{'active':currentPageName === 'kempelen' }">
                                    ...
                                    <path class="st0" d="M630.4,1110.4c-6.7,0-12.2-3.5-14.6-5c-11.7-7.6-14.8-20.6-16-26.2c-1.5-6.5-5.4-23.6,5.2-33.5
                                        ...
                                        <rect x="337.5" y="936.1" transform="matrix(0.4785 -0.8781 0.8781 0.4785 -716.0264 831.9775)" class="st0" width="10" height="165.4"/>
                                    
                                        <rect x="341.7" y="960.9" transform="matrix(0.4093 -0.9124 0.9124 0.4093 -740.2213 928.212)" class="st0" width="10" height="149.7"/>
                                    
                                        <rect x="338.4" y="971.9" transform="matrix(0.328 -0.9447 0.9447 0.328 -758.9731 1028.4777)" class="st0" width="10" height="151.7"/>
                                    
                                        <rect x="341.7" y="993.7" transform="matrix(0.2531 -0.9674 0.9674 0.2531 -770.6517 1130.3643)" class="st0" width="10" height="141.2"/>
                                    
                                        <rect x="406.5" y="965.9" transform="matrix(0.6521 -0.7581 0.7581 0.6521 -592.6383 649.6641)" class="st0" width="10" height="9.3"/>
                                    ...
                                    <rect x="543.3" y="1058.6" class="st0" width="10" height="16.7"/>
                                        ...
                                        <rect x="534.1" y="1059" transform="matrix(0.9536 -0.3012 0.3012 0.9536 -296.701 211.9843)" class="st0" width="10" height="18.4"/>
                                    
                                        <rect x="508" y="1050.4" transform="matrix(0.9841 -0.1774 0.1774 0.9841 -178.7461 111.9691)" class="st0" width="57.3" height="10"/>
                                ...
                                <g id="Titel_3_" :class = "{'active':currentPageName === 'kempelen' }">
                            ...
                            <g id="Formanten"  class="component" ref="formant">
                                <g id="Icon_3_" :class = "{'active':currentPageName === 'formant' }">
                                ...
                                <g id="Titel_4_" :class = "{'active':currentPageName === 'formant' }">
...
export default class Navigation extends Vue {
   ...
   @Prop() currentPageName!:string; 
    ...
    mounted(){
        ...
        const anatomy = this.$refs.anatomy as HTMLElement;
        const formant = this.$refs.formant as HTMLElement;
        const synthesis = this.$refs.synthesis as HTMLElement;
        const kempelen = this.$refs.kempelen as HTMLElement;
        const resonator = this.$refs.resonator as HTMLElement;

        anatomy.addEventListener("click", () => {
            this.$router.push('/anatomy')
        });
         formant.addEventListener("click", () => {
            this.$router.push('/formant')
        });
         synthesis.addEventListener("click", () => {
            this.$router.push('/synthesis')
        });
         kempelen.addEventListener("click", () => {
            this.$router.push('/kempelen')
        });
         resonator.addEventListener("click", () => {
            this.$router.push('/resonator')
        });
